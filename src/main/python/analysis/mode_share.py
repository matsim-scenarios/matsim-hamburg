...
runId = "hamburg-v2.2-25pct-base"
trips_info_folder = 'D:/ReallabHH/v3.0/25pct/hv3-25-2/'
...
person_to_home = pd.read_csv('D:/svn/shared-svn/projects/matsim-hamburg/hamburg-v3/hamburg-v3.0-person2HomeLocation.csv')
